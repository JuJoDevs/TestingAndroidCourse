...
class UpdateCartItemUseCaseTest {
    ...
    @Test
    fun given_zero_quantity_when_invoke_the_removes_items_from_cart() = runTest {
        // Given
        val productId = "id1"
        val product = product {
            withId(productId)
    ...
    @Test
    fun given_requested_quantity_greater_than_stock_when_invoke_then_throws_insufficient_stock() = runTest {
