...
class GetProductsUseCaseTest {
    ...
    @Test
    fun `GIVEN promotion ending WHEN invoke THEN it should be included`() = runTest {
    ...
    @Test
    fun `GIVEN active promotion WHEN time advances THEN it should no be longer be returned`() = runTest {
        val now = Instant.parse("2026-04-03T10:00:00Z")
        val productId = "product-Id"
        val product = product {
            withId(productId)
