...
class SettingsScreenTest: ComposeTest() {
    ...
    @Test
    fun givenInStockOnlyFalse_whenRendered_thenSwitchIsOff() = withComposeRule {
        createSettingsScreen(uiState = SettingsUiState(inStockOnly = false))
        onNodeWithTag(SETTINGS_IN_STOCK_SWITCH).assertIsOff()
    }

    @Test
    fun givenInStockOnlyTrue_whenRendered_thenSwitchIsTrue() = withComposeRule {
        createSettingsScreen(uiState = SettingsUiState(inStockOnly = true))
        onNodeWithTag(SETTINGS_IN_STOCK_SWITCH).assertIsOn()
    }

    @Test
    fun givenLightTheme_whenRendered_thenLightOptionSelected() = withComposeRule {
    ...
    @Test
    fun givenSystemTheme_whenRendered_thenLightOptionSelected() = withComposeRule {
    ...
    @Test
    fun givenDarkTheme_whenRendered_thenLightOptionSelected() = withComposeRule {
    ...
    @Test
    fun givenSettingsRendered_whenBackClicked_thenEmitBackCallback() = withComposeRule {
    ...
    @Test
    fun givenInStockSwitchOff_whenClicked_thenEmitsTrue() = withComposeRule {
        var emitted = false
    ...
    @Test
    fun givenLightTheme_whenDarkClicked_thenEmitsDarkTheme() = withComposeRule {
