...
class CartScreenTest : ComposeTest() {
    ...
    @Test
    fun givenLoadingState_whenRendered_thenShowProgressBar() =
        withComposeRule {
    ...
    @Test
    fun givenErrorState_whenRetryClicked_thenEmitsRetryAction() =
        withComposeRule {
    ...
    @Test
    fun givenSuccessState_whenRendered_thenShowsQuantitiesAndSummary() =
        withComposeRule {
