...
class CartRepositoryImplTest {
    ...
    @Test
    fun givenEmptyCart_whenGetCartItemsIsCalled_thenFlowEmitsEmptyList() = runTest {
    ...
    @Test
    fun givenCartWithItems_whenAddToCartIsCalled_thenItemIsAdded() = runTest {
        val productId = "p1"
        val quantity = 2
    ...
    @Test
    fun givenCartWithItem_whenAddToCartSameProductIsCalled_thenQuantityIsUpdated() = runTest {
        val productId = "p1"
    ...
    @Test
    fun givenCartWithItems_whenRemoveFromCartIsCalled_thenItemIsRemoved() = runTest {
        val productId = "p1"
    ...
    fun givenCartWithoutItem_whenRemoveFromCartIsCalled_thenThrowNotFoundError() = runTest {
        cartRepository.removeFromCart("non-existent")
    }

    @Test
    fun givenCartWithItems_whenUpdateQuantityIsCalled_thenQuantityIsUpdated() = runTest {
        val productId = "p1"
        cartRepository.addToCart(productId, 1)
    ...
    @Test(expected = AppError.NotFoundError::class)
    fun givenCartWithoutItem_whenUpdateQuantityIsCalled_thenThrowNotFoundError() = runTest {
        cartRepository.updateQuantity("non-existent", 5)
    }

    @Test
    fun givenCartWithItems_whenClearCartIsCalled_thenCartIsEmpty() = runTest {
    ...
    @Test
    fun givenCartWithItems_whenGetCartItemByIdIsCalled_thenReturnCorrectItem() = runTest {
        val productId = "p1"
    ...
    @Test
    fun givenCartWithoutItem_whenGetCartItemByIdIsCalled_thenReturnNull() = runTest {
