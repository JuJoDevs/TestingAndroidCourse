...
class CartDaoTest {
    ...
    @Test
    fun givenInsertItem_whenGetItemById_thenReturnsCorrectItem() =
        runTest {
            val id = "id"
            val quantity = 3
    ...
    @Test
    fun givenExistingItem_whenUpdateItemQuantity_thenQuantityIsUpdate() =
        runTest {
            val id = "id"
            val oldQuantity = 1
            val newQuantity = 67
    ...
    @Test
    fun givenExistingItemId_whenInsetDuplicateId_thenItemIsReplaced() =
        runTest {
            val id = "id"
            val oldQuantity = 1
            val newQuantity = 27
