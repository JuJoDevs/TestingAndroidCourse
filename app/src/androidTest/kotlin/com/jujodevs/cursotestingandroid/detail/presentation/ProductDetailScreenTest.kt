...
class ProductDetailScreenTest : ComposeTest() {
    ...
    @Test
    fun givenLoadingState_whenRendered_thenShowsLoading() =
        withComposeRule {
    ...
    @Test
    fun givenProduct_whenRendered_thenShowsProductDetails() =
        withComposeRule {
            val product = bread
            val uiState =
    ...
    @Test
    fun givenProductWithBuyXPayYPromotion_whenRendered_thenShowsPromoLabel() =
        withComposeRule {
            val product = product()
    ...
    @Test
    fun givenProductNoStock_whenRendered_thenShowsNoStockAndButtonDisabled() =
        withComposeRule {
            val product =
                product {
                    withStock(0)
    ...
    @Test
    fun givenProduct_whenAddToCartClicked_thenEmitsAddToCartAction() =
        withComposeRule {
    ...
    @Test
    fun givenProduct_whenBackClicked_thenEmitsGoBackAction() =
        withComposeRule {
