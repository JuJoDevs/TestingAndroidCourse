...
class ProductRepositoryImplTest {
    ...
    @Test
    fun givenValidProductsJson_whenRefreshIsCalled_theDatabaseEmitProductsFromRoom() =
        runTest {
    ...
    @Test
    fun givenProductsJson_whenRefreshAndGetProductById_theReturnCorrectProduct() =
        runTest {
            mockWebServer.server.enqueue(MockResponse().setBody(productsJson).setResponseCode(200))
    ...
    fun givenServerReturns500_whenRefreshIsCalled_thenInThrowException() =
        runTest {
    ...
    @Test
    fun givenProductsEndpoint_whenRefreshIsCalled_thenRequestIsGetCorrectPath() =
        runTest {
            mockWebServer.server.enqueue(MockResponse().setBody(productsJson).setResponseCode(200))
            productRepository.refreshProducts()
