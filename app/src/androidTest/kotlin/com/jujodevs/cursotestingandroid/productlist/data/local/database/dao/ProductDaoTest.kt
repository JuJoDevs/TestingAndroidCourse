...
class ProductDaoTest {
    ...
    @Test
    fun givenInsertedProduct_whenGetProductById_thenReturnsRow() =
        runTest {
            val id = "id"
    ...
    @Test
    fun givenOldProducts_whenReplaceAll_thenReplacesOldProducts() =
        runTest {
            val oldId1 = "old-id1"
            val oldId2 = "old-id2"
            val id1 = "id1"
    ...
    @Test
    fun givenExistingProduct_whenInsertSameIdWithDifferentData_thenReplacesOldData() =
        runTest {
            val productId = "id"
            val name1 = "bread"
            val name2 = "milk"
