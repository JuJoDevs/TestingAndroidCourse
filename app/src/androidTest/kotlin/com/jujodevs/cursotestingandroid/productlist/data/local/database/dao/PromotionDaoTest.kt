...
class PromotionDaoTest {
    ...
    @Test
    fun givenInsertedPromotions_whenGetAllPromotions_thenReturnsThem() =
        runTest {
    ...
    @Test
    fun givenExistingPromotions_whenClearPromotions_thenDatabaseIsEmpty() =
        runTest {
            dao.insertAllPromotions(
                listOf(
    ...
    @Test
    fun givenOldPromotions_whenReplaceAll_thenReplacesOldPromotions() =
        runTest {
            val oldId = "old-id"
            val newId = "new-id"
    ...
    @Test
    fun givenExistingPromotion_whenInsertSameIdWithDifferentData_thenReplacesOldData() =
        runTest {
            val promotionId = "id"
            val oldPercent = 10
            val newPercent = 20
    ...
    @Test
    fun givenFlowSubscribed_whenInsertAfterSubscribe_thenEmitsUpdatedList() =
        runTurbineTest {
            val id = "2"
